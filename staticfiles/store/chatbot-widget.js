...
(function () {
  ...
  document.querySelectorAll("#sv-chat-bubble, .sv-chat-bubble, .chatbot-fab, .ai-chat-fab, .floating-ai-button, .floating-chat-button, #backToTop, .back-to-top").forEach((el) => el.remove());
